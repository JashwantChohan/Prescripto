        ...
        {appointments.map((item, index) => (
          <div className='gird grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b border-zinc-400' key={index}>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              ...
              <button onClick={() => cancelAppointment(item._id)} className='text-sm text-stone-500 text-center sm:min-w-48 py-2  border rounded hover:bg-red-600 hover:text-white transiton-all duration-300'>Cancel Appointment </button>
            </div>
